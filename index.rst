...
For information on solving a CellML model with a simple numerical solver, please see the :usecases:`solving a generated model page <solver>`.
...
For more information on their theoretical background, please see the :libcellml_doc_page:`Hodgkin-Huxley theory pages <theory>`.
